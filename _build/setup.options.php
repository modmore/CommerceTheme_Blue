...
<p>
    ...
    Theme Blue allows you to compile your own styles based on the distribution. Instructions on how to do that can be found in the readme under assets/components/commercetheme_red/. If you want to revert to the defaults, tick this box. It may be necessary to manually apply styling changes if you do not overwrite the custom styling.
</p>
HTML;
